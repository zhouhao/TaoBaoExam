...
namespace Examination.BusinessLogicLayer
{
    ...
    public class MultiProblem
    {
        ...
        public bool InsertByProc()
        {
            ...
            Params[6] = DB.MakeInParam("@DiffID", SqlDbType.Int, 4, DiffID);      //难度系数
            Params[7] = DB.MakeInParam("@Answer", SqlDbType.VarChar, 50, Answer);               //参考答案
            int Count = -1;
        ...
        public bool UpdateByProc(int TID)
        {
            ...
            Params[7] = DB.MakeInParam("@DiffID", SqlDbType.Int, 4, DiffID);      //难度系数
            Params[8] = DB.MakeInParam("@Answer", SqlDbType.VarChar, 50, Answer);               //参考答案
        ...
        public bool isReduplicated(string title)
        {
            ...
            if (DB.GetRecordCount("select count(*) from MultiProblem where Title='" + title + "' ") != 0)
                return true;
            else
                return false;
        }
