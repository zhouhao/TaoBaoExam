...
namespace Examination.BusinessLogicLayer
{
    ...
    public class JudgeProblem
    {
        ...
        public bool InsertByProc()
        {
            ...
            Params[3] = DB.MakeInParam("@Answer", SqlDbType.Bit, 1, Answer);                      //答案A            
        ...
        public bool UpdateByProc(int TID)
        {
            ...
            Params[4] = DB.MakeInParam("@Answer", SqlDbType.Bit, 1, Answer);                      //答案A            
        ...
        public bool isReduplicated(string title)
        {
            ...
            if (DB.GetRecordCount("select count(*) from JudgeProblem where Title='" + title + "' ") != 0)
                return true;
            else
                return false;
        }
