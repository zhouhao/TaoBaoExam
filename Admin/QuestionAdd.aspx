<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="QuestionAdd.aspx.cs" Inherits="Admin_QuestionAdd" Title="问答题编辑与添加" %>
...
<table cellpadding="0" cellspacing="0" border="1"  bordercolor="#cccccc" style="border-collapse:collapse" width="100%" frame="below">
              <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                    &nbsp;<div align="left"><asp:textbox id="txtTitle"  runat="server" Width="100%" TextMode="MultiLine"	Height="80px"></asp:textbox>
								<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTitle"
                            ErrorMessage="不能为空！"></asp:RequiredFieldValidator></div>
                </tr>
                <tr>
                    <td bgcolor="#eeeeee" style="text-align:right;">答案：</td>
                    <td colspan="3">&nbsp;<div align="left"> <asp:textbox id="txtAnswer"  runat="server"  Width="100%" TextMode="MultiLine"
