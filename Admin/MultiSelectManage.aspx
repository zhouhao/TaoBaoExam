<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="MultiSelectManage.aspx.cs" Inherits="Admin_MultiSelectManage" Title="多选题管理" %>
...
<h4> &gt;&gt;多选题管理</h4> 
                       ...
                       <asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="True" Width="130px" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged"></asp:DropDownList></p>
                    ...
                    <Columns>                       
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="MultiSelectAdd.aspx?ID={0}" HeaderText="详细..." Text="详细..." />                                           
            ...
            <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
                      ...
                      <br /><a href="MultiSelectAdd.aspx" style="font-size:medium;"><font color=red><u>添加多选题</u></font></a>          
