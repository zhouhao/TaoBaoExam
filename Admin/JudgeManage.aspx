<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="JudgeManage.aspx.cs" Inherits="Admin_JudgeManage" Title="判断题管理" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <h4>&gt;&gt;判断题管理</h4>  
                    ...
                    <Columns>                       
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="JudgeAdd.aspx?ID={0}" HeaderText="详细..." Text="详细..." />                                           
            ...
            <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
                      ...
                      <br /><a href="JudgeAdd.aspx" style="font-size:medium;"><font color=red><u>添加判断题</u></font></a>          
