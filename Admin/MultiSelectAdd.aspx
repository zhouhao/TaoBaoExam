<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="MultiSelectAdd.aspx.cs" Inherits="Admin_MultiSelectAdd" Title="多选题编辑与录入" %>
                ...
                <tr>
                    ...
                    &nbsp;<div align="left">
                            <asp:textbox id="txtTitle"  
                                runat="server" Width="100%" TextMode="MultiLine"　Height="50px" 
